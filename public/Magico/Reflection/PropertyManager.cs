...
namespace Magico.Reflection
{
    ...
    public static class PropertyManager
    {
        ...
        public static void SetPropertyValueInstance<T>(T instance, string Variable, object? VariableValue) =>
            SetPropertyValueInstance(instance, Variable, VariableValue, instance?.GetType());
        ...
        public static object? GetPropertyValueInstance<T>(T instance, string Variable) =>
            GetPropertyValueInstance(instance, Variable, instance?.GetType());
        ...
        public static Dictionary<string, object?> GetProperties(Type VariableType)
        {
            ...
            foreach (PropertyInfo VarProperty in Properties)
            {
                ...
                {
                    Debug.WriteLine($"Error getting property value {VarProperty.Name} for {VariableType.Name}: {ex}");
                }
            }
            return PropertyDict;
        }
        ...
        /// <returns>Dictionary containing all properties</returns>
        public static Dictionary<string, object?> GetAllProperties(Type[] types)
        {
            // Get property for specified variable
            var PropertyDict = new Dictionary<string, object?>();
            foreach (var type in types)
            {
                ...
                {
                    Debug.WriteLine($"Error getting property value for {type.Name}: {ex}");
                }
            }
            return PropertyDict;
        }
        ...
        /// <param name="types">Array of types to query</param>
        /// <returns>Dictionary containing all properties</returns>
        public static Dictionary<string, Type> GetAllPropertiesNoEvaluation(Type[] types)
        {
            // Get property for specified variable
            var PropertyDict = new Dictionary<string, Type>();
            foreach (var type in types)
            {
                ...
                {
                    Debug.WriteLine($"Error getting property for {type.Name}: {ex}");
                }
            }
            return PropertyDict;
        }
        ...
        /// <param name="types">Array of types to query</param>
        /// <returns>Dictionary containing all properties</returns>
        public static Dictionary<string, object?> GetAllProperties<T>(T instance, Type[] types)
        {
            // Get property for specified variable
            var PropertyDict = new Dictionary<string, object?>();
            foreach (var type in types)
