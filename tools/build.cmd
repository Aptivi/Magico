...
"%ProgramFiles%\dotnet\dotnet.exe" restore "%ROOTDIR%\Magico.sln" -p:Configuration=%releaseconfig% %buildoptions%
...
:build
echo Building...
"%ProgramFiles%\dotnet\dotnet.exe" build "%ROOTDIR%\Magico.sln" -p:Configuration=%releaseconfig% %buildoptions%
